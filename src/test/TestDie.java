...
/**
 * Test of the die class used in the entities.Cup class. 
 **/
...
public class TestDie {
	...
	@Before
	/**
	 * Creates a dice object before running the test. 
	 * @throws Exception
	 */
	...
	@Test
	/**
	 * The test throws a die 600000 times, and counts the different return values of the roll
	 * the assertTrue, methods uses the counts to evaluate the actual outcome with the theoretic outcome. 
	 * there's a acceptance of 4% deviation on the counts. 
	 * Lastly the counts are being printed out in the console. 
	 */
