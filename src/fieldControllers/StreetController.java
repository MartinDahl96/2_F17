...
public class StreetController {
	...
	public void sellProperty(Player player, Street s) {
		...
		String input = MUI.getUserString("Indtast feltnummer for at sælge et hus");
			...
			if(fieldNumber == field.getFieldID()){
				if(((Street)field).getOwner() == player){
					if (field instanceof Street && ((Street)field).getNumOfBuildings()>0){
						...
						// Efter hus/hotel grafisk er fjernet, får spilleren halvdelen af købsprisen tilbage
	...
	//TODO: Find ud af om nedenstående kode skal bruges. PT bruges buildable() fra Street i stedet. 
